...
contract BaseRegistrarImplementation is ERC721, BaseRegistrar  {
    ...
    constructor(FID _fid, bytes32 _baseNode) ERC721("","") {
        fid = _fid;
        baseNode = _baseNode;
    }

    modifier live {
        require(fid.owner(baseNode) == address(this));
        _;
    }
    ...
    function setResolver(address resolver) external override onlyOwner {
        fid.setResolver(baseNode, resolver);
    }
    ...
    /**
     * @dev Reclaim ownership of a name in FID, if you own it in the registrar.
     */
